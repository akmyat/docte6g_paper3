\subsection{Network Simulation with NS-3}

Validating these complex interactions in physical testbeds is often cost-prohibitive and risky.
Network simulation offers a viable alternative for pre-deployment verfication.
...
However, a significant gap exist in the current ns-3 ecosystem: the lack of a native, feature-complete MQTT model.
Previous contributions, such as those by Augusto, provided complied binaries without source code, preventing meaningful modification, extension, or validation\cite{ref_17}.
